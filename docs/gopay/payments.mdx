...
<Warning>
  Jangan membuat matcher menerima skala mentah dan skala rupiah sekaligus.
  Transaksi Rp 300.100 dapat keliru melunasi pesanan Rp 3.001.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card
    title="Referensi PaymentService"
    icon="code"
    href="/api/payment-service"
  >
