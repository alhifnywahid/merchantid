...
<Warning>
  Parser menolak payload malformed dan panjang yang keluar dari batas dengan
  `QRIS_PARSE_ERROR`. Tanpa penjagaan itu, payload terpotong akan "berhasil"
  diparse lalu diterbitkan ulang di bawah CRC yang baru dihitung - data merchant
  korup yang memakai checksum valid.
</Warning>
